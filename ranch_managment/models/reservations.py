...
class Reservation(models.Model):
    ...
    kids = fields.Integer()
    notes = fields.Text()
    deposit_request_sent = fields.Boolean( default=False)
    deposit_request_received = fields.Boolean(default=False)
    deposit_request_received_date = fields.Date()
    state = fields.Selection([('draft', 'Draft'), ('confirmed', 'Confirmed'), ('cancelled', 'Cancelled')],
                             default='draft')
    is_driving = fields.Boolean(string="Driving?", default=False)
